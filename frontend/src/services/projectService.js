...
const projectService = {
   ...
   *  Changed from /projects/{id}/investigators to /investigators/project/{id}
   * @param {number} projectId - Project ID
   */
   ...
   *  Changed from /projects/{id}/budget-allocations to /budget/allocation/project/{id}
   * @param {number} projectId - Project ID
   */
   ...
   *  Now requires allocation_id, not project_id
   * @param {number} allocationId - Allocation ID
   ...
   *  : Changed from /projects/{id}/manpower to /manpower/project/{id}
   * @param {number} projectId - Project ID
  ...
  async addManpower(manpowerData) {
    ...
    if (manpowerData.date_incurred)
      params.append("date_incurred", manpowerData.date_incurred);
   ...
   *  : Changed from /projects/{id}/equipment to /equipment/project/{id}
   * @param {number} projectId - Project ID
  ...
  async addEquipment(equipmentData) {
    ...
    if (equipmentData.purchase_date)
      params.append("purchase_date", equipmentData.purchase_date);
   ...
   *  : Changed from /projects/{id}/funds-received to /funds/received/project/{id}
   * @param {number} projectId - Project ID
   ...
   *  : Changed from /funds-received to /funds/received
   ...
   *  : Changed from /projects/{id}/expenditure to /expenditure/project/{id}
   * @param {number} projectId - Project ID
   * @param {Object} params - Query parameters (head filter, pagination)
   */
  ...
  async addExpenditure(expenditureData) {
    ...
    if (expenditureData.date_incurred)
      params.append("date_incurred", expenditureData.date_incurred);
    if (expenditureData.description)
      params.append("description", expenditureData.description);
