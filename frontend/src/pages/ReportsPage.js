...
const ReportsPage = () => {
  ...
  const fetchProjects = async () => {
    try {
      ...
      // Try different methods to get projects based on what your projectService exposes
      let data;
      ...
      if (Array.isArray(data)) {
        ...
        // Paginated response: { projects: [...], total: N }
        projectList = data.projects;
      } else if (data && Array.isArray(data.data)) {
        // Response wrapped in data: { data: [...] }
        projectList = data.data;
      } else if (data && typeof data === 'object') {
        // Check if the data object itself has project properties
        projectList = [data];
      } else {
        projectList = [];
      }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {error && (
          <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4 flex items-start">
            ...
            <div>
              <h3 className="text-sm font-semibold text-red-900 mb-1">Error Loading Projects</h3>
